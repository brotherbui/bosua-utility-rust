...
use bosua_lib::commands::register_gcp_commands;
...
async fn main() {
    ...
    // Step 1.5 (GCP-specific): Initialize DynamicConfig + NotificationManager
    ...
    // Step 7: Register GCP variant commands
    ...
    match matches.subcommand() {
        ...
        None => {
            ...
            register_gcp_commands(&mut CommandRegistry::new(cmd.clone()));
