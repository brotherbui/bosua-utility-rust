...
use bosua_lib::commands::register_linux_commands;
...
use bosua_lib::notifications::NotificationManager;
...
async fn main() {
    ...
    // Step 1.5 (Linux-specific): Initialize DynamicConfig + NotificationManager
    ...
    // Step 7: Register Linux variant commands
    ...
    match matches.subcommand() {
        ...
        None => {
            ...
            register_linux_commands(&mut CommandRegistry::new(cmd.clone()));
